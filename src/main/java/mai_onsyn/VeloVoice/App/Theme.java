...
public class Theme {
    ...
    static {
        ...
        TREE_SWITCHED_TEXT_COLOR = Toolkit.adjustBrightness(Toolkit.adjustHue(TREE_SWITCHED_BACKGROUND_COLOR, TREE_SWITCHED_BACKGROUND_COLOR.getHue() + 180, 1), LIGHT_THEME ? 0.2 : 1);
        TREE_SWITCHED_TEXT_FOCUS_COLOR = Toolkit.adjustBrightness(Toolkit.adjustHue(TREE_SWITCHED_BACKGROUND_FOCUS_COLOR, TREE_SWITCHED_BACKGROUND_FOCUS_COLOR.getHue() + 180, 1), LIGHT_THEME ? 0.6 : 0.8);
    }
}