...
import mai_onsyn.AnimeFX.Styles.AXSwitchStyle;
import mai_onsyn.AnimeFX.Styles.DefaultAXSwitchStyle;
...
public class AXSwitch extends AXBase {
    ...
    public void setTheme(AXSwitchStyle style) {
        this.style = style;
        thumb.setTheme(stateProperty.get() ? style.getSwitchedThumbStyle() : style.getThumbStyle());
        super.setTheme(stateProperty.get() ? style.getSwitchedTrackStyle() : style.getTrackStyle());
    }
