...
public class Constants {
    ...
    static {
        LANG_HEADCODE_TO_NAME_MAPPING = Map.ofEntries(
    ...
    public static class I18nKeyMaps {
        public static final Map<String, String> CONTEXT_MENU = new HashMap<>();



        static {
            CONTEXT_MENU.put("new file", "frame.context_menu.new_file");
            CONTEXT_MENU.put("new folder", "frame.context_menu.new_folder");
            CONTEXT_MENU.put("copy", "frame.context_menu.copy");
            CONTEXT_MENU.put("cut", "frame.context_menu.cut");
            CONTEXT_MENU.put("paste", "frame.context_menu.paste");
            CONTEXT_MENU.put("paste append", "frame.context_menu.paste_append");
            CONTEXT_MENU.put("rename", "frame.context_menu.rename");
            CONTEXT_MENU.put("move up", "frame.context_menu.move_up");
            CONTEXT_MENU.put("move down", "frame.context_menu.move_down");
            CONTEXT_MENU.put("expand all", "frame.context_menu.expand_all");
            CONTEXT_MENU.put("clear", "frame.context_menu.clear");
            CONTEXT_MENU.put("delete", "frame.context_menu.delete");
            CONTEXT_MENU.put("undo", "frame.context_menu.undo");
            CONTEXT_MENU.put("select all", "frame.context_menu.select_all");
        }
    }
}